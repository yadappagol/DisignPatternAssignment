...
import com.te.designpatternAssignment.dao.HibernateImplementation;
import com.te.designpatternAssignment.dao.WrongInputException;

public class Workers_Service_Hibernate_Implementation implements Workers_Service {

	DesignPatternCrud designPatternCrud=new HibernateImplementation();
	
	public static Workers_Service getService() {
		return new Workers_Service_Hibernate_Implementation();
	}
	
	private Workers_Service_Hibernate_Implementation() {
